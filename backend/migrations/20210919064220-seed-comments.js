...
exports.up = function (db) {
  ...
  return (
    ...
    db.insert(tables.hospital, [...comment5.rows], [...comment5.content]),
    ...
    db.insert(tables.room, [...comment5.rows], [...comment5.content]),
    ...
    db.insert(tables.nursery, [...comment5.rows], [...comment5.content])
  );
};
